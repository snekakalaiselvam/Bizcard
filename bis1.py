...
# HOME MENU
if selected == "HOME":
    st.title(":violet[Project Title :]BizCardX: Extracting Business Card Data with OCR") 
    st.title(":violet[Technologies used:]Python,easy OCR, Streamlit, SQL, Pandas")
    st.title(":violet[Overview:] In this streamlit web app you can upload an image of a business card and extract relevant information from it using easyOCR. You can view, modify or delete the extracted data in this app. This app would also allow users to save the extracted information into a database along with the uploaded business card image. The database would be able to store multiple entries, each with its own business card image and extracted information.")
    st.balloons()
# UPLOAD AND EXTRACT MENU
if selected == "UPLOAD & EXTRACT":
    st.markdown("Here, Upload a Business Card")
